<%-- 
    ...
    Created on : 22-04-2014, 12:41:13 PM
    Author     : Joseph
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>                        
                        <a href="ProductMainServlet"><i class="text-primary fa fa-table"></i> DataTable Productos </a>
                    </li>                                 
                </ol>
                <!-- end breadcrumb -->
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                              
                            <div class="btn-toolbar">                                    
                                <object align="right">
                                    ...
                                    <div class="btn-group">                                                      
                                        <button class="btn btn-default btn-sm" name="btnAdd" type="button" onclick="location.href = 'ProductAddServlet';" rel="tooltip" data-placement="top" data-original-title="Nuevo Producto">
                                            ...
                                            <table id="datatable_col_reorder" class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach var="list" items="${list}">
                                                        <tr>
                                                            <td class="center">
                                                                <c:if test="${list.idProduct != idProductX}" >                                                                
                                                            ...
                                                            <td><c:out value="${list.idProduct}" /></td>
                                                            <td><c:out value="${list.productName}" /></td>
                                                            <td><c:out value="${list.productCode}" /></td>
                                                            <td><c:out value="${list.productCategory}" /></td>
                                                            <td><c:out value="${list.productDescription}" /></td>
                                                            <td><c:out value="${list.productImage}" /></td>
                                                            <td><c:out value="${list.productType}" /></td>
                                                            <td><c:out value="${list.productWeight}" /></td>
                                                            <td><c:out value="${list.productMark}" /></td>
                                                            <!--
                                                            <td>                                                                
