<%-- 
    Document   : trademarkAdd
    Created on : 25-04-2014, 12:52:54 PM
    Author     : Joseph
--%>
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-edit"></i> Agregar Marca
                    </li>
                </ol>
                <!-- end breadcrumb -->
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-togglebutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="trademarkAddServlet" method="POST" name="formAdd" id="formAdd" class="smart-form" novalidate="novalidate">

                                            <fieldset>
                                                <div class="row">
                                                    <section class="col col-6">                                                        
                                                        <c:if test="${msgErrorTrademarkName == null}">                                                           
                                                            <label class="label">Nombre Marca</label>
                                                            <label class="input"> <i class="icon-prepend fa fa-coffee"></i>
                                                                <input type="text" maxlength="30" name="trademarkName" placeholder="Ingrese Nombre Marca" value="<c:out value="${trademarkName}" />">
                                                                <b class="tooltip tooltip-top-right"><i class="fa fa-warning txt-color-teal"></i> Por ejemplo: NombreMarca</b>
                                                            </label>
