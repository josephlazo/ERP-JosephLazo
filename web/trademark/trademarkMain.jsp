<%-- 
    Document   : trademarkMain
    Created on : 25-04-2014, 12:28:23 PM
    Author     : Joseph
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>                        
                        <a href="trademarkMainServlet"><i class="text-primary fa fa-table"></i> DataTable Marca </a>
                    </li>                                 
                </ol>
                <!-- end breadcrumb -->
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                              
                            <div class="btn-toolbar">                                    
                                <object align="right">
                                    ...
                                    <div class="btn-group">                                                      
                                        <button class="btn btn-default btn-sm" name="btnAdd" type="button" onclick="location.href = 'trademarkAddServlet';" rel="tooltip" data-placement="top" data-original-title="Nueva Marca">
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2" data-widget-togglebutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="ProductDeleteServlet" method="post" name="form">
                                            <table id="datatable_col_reorder" class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach var="list" items="${list}">
                                                        <tr>
                                                            <td class="center">
                                                                <c:if test="${list.idTrademark != idTrademarkX}" >                                                                
                                                            ...
                                                            <td><c:out value="${list.idTrademark}" /></td>
                                                            <td><c:out value="${list.trademarkName}" /></td>


                                                            <td width=280>
                                                                <div align="right">
                                                                    <a href="UserGetServlet?id=<c:out value="${list.idTrademark}"/>">
                                                                    ...
                                                                    <c:if test="${list.idTrademark != idTrademarkX}" >
                                                                        <button class="btn btn-labeled btn-danger" name="btnDelRow" id="btnDelRow<c:out value="${list.idTrademark}"/>">                                                
                                                                            <span class="btn-label"><i class="glyphicon glyphicon-trash"></i></span>
                                                                            <strong><font size="1">ELIMINAR</font></strong>
                                                                        </button>
                                                                        <input type="hidden" name="idTrademarkDelRow<c:out value="${list.idTrademark}"/>" id="idTrademarkDelRow<c:out value="${list.idTrademark}"/>" value="<c:out value="${list.idTrademark}"/>">
                                                                    </c:if>
                                                                    <c:if test="${list.idTrademark == idTrademarkX}" >
