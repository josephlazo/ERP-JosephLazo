<%-- 
    Document   : categoryMain
    Created on : 25-04-2014, 01:16:51 PM
    Author     : Joseph
--%>
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                              
                            <div class="btn-toolbar">                                    
                                <object align="right">
                                    ...
                                    <div class="btn-group">                                                      
                                        <button class="btn btn-default btn-sm" name="btnAdd" type="button" onclick="location.href = 'categoryAddServlet';" rel="tooltip" data-placement="top" data-original-title="Nueva Categoría">
                                            ...
                                            <table id="datatable_col_reorder" class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach var="list" items="${list}">
                                                        <tr>
                                                            <td class="center">
                                                                <c:if test="${list.idCategory != idCategoryX}" >                                                                
