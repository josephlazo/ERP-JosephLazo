<%-- 
    ...
    Created on : 25-04-2014, 04:01:27 PM
    Author     : Joseph
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="categoryMainServlet"><i class="text-primary fa fa-table"></i> DataTable Categoría</a>
                    </li>
                    <li>
                        <i class="fa fa-edit"></i> Agregar Categoría
                    </li>
                </ol>
                <!-- end breadcrumb -->
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-togglebutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="categoryAddServlet" method="POST" name="formAdd" id="formAdd" class="smart-form" novalidate="novalidate">

                                            <fieldset>
                                                <div class="row">
                                                    <section class="col col-6">                                                        
                                                        <c:if test="${msgErrorCategoryName == null}">                                                           
                                                            <label class="label">Nombre Categoría</label>
                                                            <label class="input"> <i class="icon-prepend fa fa-list-ul"></i>
                                                                <input type="text" maxlength="30" name="categoryName" placeholder="Ingrese Nombre de Categoría" value="<c:out value="${categoryName}" />">
                                                                <b class="tooltip tooltip-top-right"><i class="fa fa-warning txt-color-teal"></i> Por ejemplo: Nombre.Categoría</b>
                                                            </label>
                                                            <div class="note note-error">Este campo es requerido.</div>
                                                        </c:if>
                                                        <c:if test="${ msgErrorCategoryName != null}">
                                                            <label class="label">Nombre Categoría</label>
                                                            <label class="input state-error"> <i class="icon-prepend fa fa-list-ul"></i>
                                                                <input type="text" maxlength="30" name="categoryName" placeholder="Ingrese Nombre de Categoría" value="<c:out value="${categoryName}" />">
                                                                <b class="tooltip tooltip-top-right"><i class="fa fa-warning txt-color-teal"></i> Por ejemplo: Nombre.Categoría</b>                                                                
                                                            </label>
                                                            <div class="note note-error">Este campo es requerido.</div>
                                                ...
                                                <div class="row">
                                                    <section class="col col-6">                                                        
                                                        <c:if test="${msgErrorCategoryDescription == null}">                                                           
                                                            <label class="label">Descripción Categoría</label>
                                                            <label class="input">
                                                                <textarea maxlength="255" name="categoryDescription" placeholder="Ingrese Descripción" rows="10" cols="30" value="<c:out value="${categoryDescription}" />"></textarea>
                                                                <b class="tooltip tooltip-top-right"><i class="fa fa-warning txt-color-teal"></i> Por ejemplo: Nombre.Categoría</b>
                                                            </label>
                                                            <div class="note note-error">Este campo es requerido.</div>
                                                        </c:if>
